 ...
 */
public class SpectrumViewNodeFactory extends NodeFactory<SpectrumViewNodeModel>
    implements WizardNodeFactoryExtension<SpectrumViewNodeModel, SpectrumViewViewRepresentation,
    SpectrumViewViewValue> {
    ...
    public SpectrumViewNodeModel createNodeModel() {
        return new SpectrumViewNodeModel(getInteractiveViewName());
    }
